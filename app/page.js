        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a href="#" className="text-gray-700 hover:text-teal-600 font-medium">Beranda</a>
              <a href="#" className="text-gray-700 hover:text-teal-600 font-medium">Program Diet</a>
              <a href="#" className="text-gray-700 hover:text-teal-600 font-medium">Cara Kerja</a>
              <a href="#" className="text-gray-700 hover:text-teal-600 font-medium">Tentang Kami</a>
              
              <div className="flex items-center space-x-4 ml-8">
                <a href="/login" className="text-gray-700 hover:text-teal-600 font-medium">MASUK</a>
                <a href="/register" className="bg-teal-600 text-white px-4 py-2 rounded-md hover:bg-teal-700 transition-colors font-medium">
                  DAFTAR
                </a>
              </div>
            </div>
    ...
    {/* Hero Section */}
      <section className="bg-gradient-to-br from-teal-400 via-teal-500 to-teal-600 relative overflow-hidden min-h-screen flex items-center">
        ...
        <div className="absolute inset-0 pointer-events-none">
          {/* Left Side Images */}
          <div className="absolute left-4 lg:left-12 top-1/4 transform -translate-y-1/2">
          ...
          <div className="absolute right-9 lg:right-10 bottom-15">
      ...
      {/* CTA Sections */}
      <section id="daftar" className="bg-white-to-r from-teal-400 to-teal-400 py-20">
        
      </section>
      <section id="daftar" className="bg-gradient-to-r from-teal-400 to-teal-400 py-20">
      ...
      <section id="masuk" className="bg-gray-800 py-16">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h3 className="text-2xl font-bold text-white mb-4">Sudah Punya Akun?</h3>
          <p className="text-gray-300 mb-6">Masuk ke akun Anda dan lanjutkan perjalanan sehat</p>
          <button className="bg-teal-600 text-white px-8 py-3 rounded-full font-semibold hover:bg-teal-700 transition-colors duration-200">
            Masuk ke Akun
          </button>
        </div>
      </section>
